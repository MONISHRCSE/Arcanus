...
description: Expert developer specializing in creating "Skills" for the Antigravity agent environment. Use when the user asks to create or generate a new skill.
---
